...
import convertDateToRelativeTime from "@/utils/relative-time";
...
const page = async ({
    ...
    const [question, answers, upvotes, downvotes, comments] = await Promise.all([
        ...
        databases.listDocuments(db, voteCollection, [
            Query.equal("typId", params.quesId),
    ...
    // since it is dependent on the question , we fetch it here outside promise.all
